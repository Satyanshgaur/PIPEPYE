#!/usr/bin/env python3
"""
Generates the complete Markdown version of the PipePye Research Monograph
containing all text, equations, tables, diagrams, and appendices from the website.
"""

import os

MD_CONTENT = r"""# PipePye: Structure-Aware Heterogeneous Optimization Dispatch Across CPU and GPU Architectures
...
def main():
    ...
    target_files = [
        os.path.join(repo_root, "website", "RESEARCH_MONOGRAPH.md")
    ]
    for target_file in target_files:
        with open(target_file, "w", encoding="utf-8") as f:
            f.write(MD_CONTENT.strip() + "\n")
        print(f"Generated {target_file} with {len(MD_CONTENT.splitlines())} lines.")
